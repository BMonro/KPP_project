...
export default function Strategy() {
    ...
    return (
        <section className="pb-8 pt-8 px-20 flex flex-col">
            ...
            <GeneralItem title={generalItem.title} options={generalItem.options} />

            <button className=" absolute bottom-[12%] bg-green py-2 px-5 mb-2 w-[15%] text-[40px] text-bText rounded-[21px] hover:shadow-custom-inset transition-shadow duration-200  self-end ">Save</button>
        </section>
    );
}
